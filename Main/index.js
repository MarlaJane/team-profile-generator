...
const appMenu =() => {
  ...
  const addEngineer = () => {
    inquirer.prompt([
      ...
      const engineer = new Engineer(managerInfo.engineerName, managerInfo.engineerId, managerInfo.engineerEmail, managerInfo.engineerGithub);
  ...
  const addIntern = () => {
    inquirer.prompt([
      ...
      const intern = new Intern(managerInfo.internName, managerInfo.internId, managerInfo.internEmail, managerInfo.internSchool);
